...
/*
Button bNavBottomHome = findViewById(R.id.homeFragment);
        bNavBottomHome.setOnClickListener(this);

        Button bNavBottomBack = findViewById(R.id.backFragment);
        bNavBottomBack.setOnClickListener(this);
*/
